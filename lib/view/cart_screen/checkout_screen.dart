...
//                     HeadingText(headingText: "${cartControleler.checkList[currentIndex][5]}")
//                   ],
//                 ),
//                 SizedBox(
//                   height: 10.h,
...
//                     HeadingText(
//   headingText: "\$${cartControleler.checkList[currentIndex][2] * cartControleler.checkList[currentIndex][4]}".toString()
// )
...
//                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                   children: [
//                     const DocumentText(documentText: "Sub Toral"),
//                     HeadingText(headingText: "\$${cartControleler.checkList[currentIndex][2] * cartControleler.checkList[currentIndex][4]}".toString())
//                   ],
//                 ),
//                 SizedBox(
//                   height: 10.h,
